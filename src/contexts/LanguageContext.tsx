...
const translations: Translations = {
  ...
  'reserva.premium.menu.info': { es: 'Descubra la auténtica esencia de la Amazonía en cada bocado.', en: 'Discover the authentic essence of the Amazon in every bite.' },
  'reserva.premium.prepay.info': { es: 'Su solicitud ha sido enviada. Nos pondremos en contacto con usted muy pronto para confirmar su mesa.', en: 'Your request has been sent. We will contact you very soon to confirm your table.' },
